"""
Django settings for amparo_backend project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'sua_secret_kay')
...
ROOT_URLCONF = 'amparo_backend.urls'
...
WSGI_APPLICATION = 'amparo_backend.wsgi.application'
